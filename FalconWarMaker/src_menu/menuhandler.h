...
signals:
  ...
  void signalResizeLevelRequested();
  void signalAddNewLevelObject();
  void signalOpenLevelObjectEditor();
public slots:
  void slot_action_Exit();
  void slot_action_Resize_Level();
  void slot_action_Save();
  void slot_action_Enable_Gravity();
  void slot_action_Disable_Gravity();
  void slot_action_Open();
  void slot_action_Add_New_Level_Object();
  void slot_action_Open_Level_Object_Editor();
